...
echo ""
echo "==> Done! This docs/ copy is a single raw snapshot with Wayback"
echo "    toolbar cruft still in it. Next, run:"
echo "    python3 consolidate.py   # merges all snapshots in site/, strips Wayback cruft"
echo "    python3 backfill_hugo.py # fills in pages Wayback never captured"

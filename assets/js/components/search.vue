...
<div class="rvtd-search">
    <form @submit.prevent="search" class="rvtd-search__form">
        ...
        <button>
            ...
            <path fill="currentColor" d="M15.71,14.29,10.89,9.47a6,6,0,1,0-1.42,1.42l4.82,4.82a1,1,0,0,0,1.42,0A1,1,0,0,0,15.71,14.29ZM6,10a4,4,0,1,1,4-4A4,4,0,0,1,6,10Z"/></svg>
        </button>
    </form>

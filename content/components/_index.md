...
{{< code >}}npm install rivet-uits@1.2.0 --save-dev
{{< /code >}}
...
{{< code lang="html" analytics-label="assets.uits.iu.edu/css link tag">}}<link rel="stylesheet" href="https://assets.uits.iu.edu/css/rivet/1.2.0/rivet.min.css">{{< /code >}}
...
{{< code lang="html" analytics-label="assets.uits.iu.edu/js script tag">}}<script src="https://assets.uits.iu.edu/javascript/rivet/1.2.0/rivet.min.js"></script>{{< /code >}}
...
<head>
    ...
    <link rel="stylesheet" href="https://assets.uits.iu.edu/css/rivet/1.2.0/rivet.min.css">
...
<body>
    ...
    <footer class="rvt-footer m-top-xxl" role="contentinfo">
        <div class="rvt-footer__copyright-lockup">
            <div class="rvt-footer__trident">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" viewBox="0 0 20 25" aria-labelledby="footer-trident" aria-hidden="true">
    ...
    <script src="https://assets.uits.iu.edu/javascript/rivet/1.2.0/rivet.min.js"></script>
</body>
</html>
{{< /code >}}

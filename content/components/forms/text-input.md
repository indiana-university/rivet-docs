...
- If you need to visually hide text from a label use the Rivet [screen reader only utility class.](https://rivet.uits.iu.edu/components/utilities/display/#screen-reader-only) That way the label text will still be accessible to screenreaders.

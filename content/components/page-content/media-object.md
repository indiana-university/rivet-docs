...
The media object is new as of 1.2.0. If you need help moving to 1.2.0, see our [instructions for updating Rivet]({{< ref "/components.md#updating-the-rivet-npm-package" >}}).
{{< /alert >}}
